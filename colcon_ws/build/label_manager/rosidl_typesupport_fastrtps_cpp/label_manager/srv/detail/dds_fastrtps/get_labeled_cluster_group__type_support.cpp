...
#include "label_manager/srv/detail/get_labeled_cluster_group__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = label_manager::srv::GetLabeledClusterGroup_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const label_manager::srv::GetLabeledClusterGroup_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<label_manager::srv::GetLabeledClusterGroup_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GetLabeledClusterGroup_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const label_manager::srv::GetLabeledClusterGroup_Request *>(
...
static size_t _GetLabeledClusterGroup_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetLabeledClusterGroup_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GetLabeledClusterGroup_Request__callbacks = {
  "label_manager::srv",
...
static rosidl_message_type_support_t _GetLabeledClusterGroup_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetLabeledClusterGroup_Request__callbacks,
...
{
  return &label_manager::srv::typesupport_fastrtps_cpp::_GetLabeledClusterGroup_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = label_manager::srv::GetLabeledClusterGroup_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const label_manager::srv::GetLabeledClusterGroup_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<label_manager::srv::GetLabeledClusterGroup_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GetLabeledClusterGroup_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const label_manager::srv::GetLabeledClusterGroup_Response *>(
...
static size_t _GetLabeledClusterGroup_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetLabeledClusterGroup_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GetLabeledClusterGroup_Response__callbacks = {
  "label_manager::srv",
...
static rosidl_message_type_support_t _GetLabeledClusterGroup_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetLabeledClusterGroup_Response__callbacks,
  get_message_typesupport_handle_function,
...
{
  return &label_manager::srv::typesupport_fastrtps_cpp::_GetLabeledClusterGroup_Response__handle;
}
...
// functions for label_manager::srv::GetLabeledClusterGroup_Request already declared above

// functions for label_manager::srv::GetLabeledClusterGroup_Response already declared above
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        label_manager::srv::typesupport_fastrtps_cpp::max_serialized_size_GetLabeledClusterGroup_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        label_manager::srv::typesupport_fastrtps_cpp::max_serialized_size_GetLabeledClusterGroup_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = label_manager::srv::GetLabeledClusterGroup_Event;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        label_manager::srv::typesupport_fastrtps_cpp::max_serialized_size_key_GetLabeledClusterGroup_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        label_manager::srv::typesupport_fastrtps_cpp::max_serialized_size_key_GetLabeledClusterGroup_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const label_manager::srv::GetLabeledClusterGroup_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<label_manager::srv::GetLabeledClusterGroup_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GetLabeledClusterGroup_Event__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const label_manager::srv::GetLabeledClusterGroup_Event *>(
...
static size_t _GetLabeledClusterGroup_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetLabeledClusterGroup_Event(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GetLabeledClusterGroup_Event__callbacks = {
  "label_manager::srv",
...
static rosidl_message_type_support_t _GetLabeledClusterGroup_Event__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetLabeledClusterGroup_Event__callbacks,
  get_message_typesupport_handle_function,
...
{
  return &label_manager::srv::typesupport_fastrtps_cpp::_GetLabeledClusterGroup_Event__handle;
}
...
static service_type_support_callbacks_t _GetLabeledClusterGroup__callbacks = {
  "label_manager::srv",
...
static const rosidl_service_type_support_t _GetLabeledClusterGroup__handle{
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetLabeledClusterGroup__callbacks,
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<label_manager::srv::GetLabeledClusterGroup_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<label_manager::srv::GetLabeledClusterGroup_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<label_manager::srv::GetLabeledClusterGroup_Event>(),
...
{
  return &label_manager::srv::typesupport_fastrtps_cpp::_GetLabeledClusterGroup__handle;
}
