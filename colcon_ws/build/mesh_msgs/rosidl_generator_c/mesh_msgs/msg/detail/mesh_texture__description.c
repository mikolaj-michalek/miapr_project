...
static char mesh_msgs__msg__MeshTexture__FIELD_NAME__uuid[] = "uuid";
static char mesh_msgs__msg__MeshTexture__FIELD_NAME__texture_index[] = "texture_index";
static char mesh_msgs__msg__MeshTexture__FIELD_NAME__image[] = "image";

static rosidl_runtime_c__type_description__Field mesh_msgs__msg__MeshTexture__FIELDS[] = {
  {
    {mesh_msgs__msg__MeshTexture__FIELD_NAME__uuid, 4, 4},
    {
  ...
  {
    {mesh_msgs__msg__MeshTexture__FIELD_NAME__texture_index, 13, 13},
    {
  ...
  {
    {mesh_msgs__msg__MeshTexture__FIELD_NAME__image, 5, 5},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription mesh_msgs__msg__MeshTexture__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {mesh_msgs__msg__MeshTexture__FIELDS, 3, 3},
    },
    {mesh_msgs__msg__MeshTexture__REFERENCED_TYPE_DESCRIPTIONS, 3, 3},
  };
  if (!constructed) {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *mesh_msgs__msg__MeshTexture__get_individual_type_description_source(NULL),
