...
#include "mesh_msgs/msg/detail/mesh_vertex_colors__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mesh_msgs::msg::MeshVertexColors & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mesh_msgs::msg::MeshVertexColors & ros_message)
{
  // Member: vertex_colors
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mesh_msgs::msg::MeshVertexColors;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mesh_msgs::msg::MeshVertexColors *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mesh_msgs::msg::MeshVertexColors *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MeshVertexColors__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mesh_msgs::msg::MeshVertexColors *>(
...
static size_t _MeshVertexColors__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MeshVertexColors(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MeshVertexColors__callbacks = {
  "mesh_msgs::msg",
  "MeshVertexColors",
...
static rosidl_message_type_support_t _MeshVertexColors__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MeshVertexColors__callbacks,
...
{
  return &mesh_msgs::msg::typesupport_fastrtps_cpp::_MeshVertexColors__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mesh_msgs, msg, MeshVertexColors)() {
  return &mesh_msgs::msg::typesupport_fastrtps_cpp::_MeshVertexColors__handle;
}
