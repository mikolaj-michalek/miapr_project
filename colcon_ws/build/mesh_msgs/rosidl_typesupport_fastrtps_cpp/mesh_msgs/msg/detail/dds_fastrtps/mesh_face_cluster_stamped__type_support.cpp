...
#include "mesh_msgs/msg/detail/mesh_face_cluster_stamped__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mesh_msgs::msg::MeshFaceClusterStamped & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mesh_msgs::msg::MeshFaceClusterStamped & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mesh_msgs
max_serialized_size_MeshFaceClusterStamped(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mesh_msgs::msg::MeshFaceClusterStamped;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mesh_msgs
max_serialized_size_key_MeshFaceClusterStamped(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const mesh_msgs::msg::MeshFaceClusterStamped *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mesh_msgs::msg::MeshFaceClusterStamped *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MeshFaceClusterStamped__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mesh_msgs::msg::MeshFaceClusterStamped *>(
...
static size_t _MeshFaceClusterStamped__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MeshFaceClusterStamped(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MeshFaceClusterStamped__callbacks = {
  "mesh_msgs::msg",
...
static rosidl_message_type_support_t _MeshFaceClusterStamped__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MeshFaceClusterStamped__callbacks,
...
{
  return &mesh_msgs::msg::typesupport_fastrtps_cpp::_MeshFaceClusterStamped__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mesh_msgs, msg, MeshFaceClusterStamped)() {
  return &mesh_msgs::msg::typesupport_fastrtps_cpp::_MeshFaceClusterStamped__handle;
}
