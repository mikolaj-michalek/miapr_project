...
static const _MeshVertexColors_type_support_symbol_names_t _MeshVertexColors_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mesh_msgs, msg, MeshVertexColors)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mesh_msgs, msg, MeshVertexColors)),
  }
};
...
{
  return &::mesh_msgs::msg::rosidl_typesupport_cpp::MeshVertexColors_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mesh_msgs, msg, MeshVertexColors)() {
  return get_message_type_support_handle<mesh_msgs::msg::MeshVertexColors>();
}
