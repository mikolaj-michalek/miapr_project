...
#define NODE_MAIN_LOGGER_NAME "ground_truth_localization_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libground_truth_localization.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<mesh_navigation_tutorials_sim::GroundTruthLocalizationNode>";
