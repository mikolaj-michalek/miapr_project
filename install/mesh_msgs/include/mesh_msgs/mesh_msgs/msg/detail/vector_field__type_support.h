...
#ifndef MESH_MSGS__MSG__DETAIL__VECTOR_FIELD__TYPE_SUPPORT_H_
#define MESH_MSGS__MSG__DETAIL__VECTOR_FIELD__TYPE_SUPPORT_H_
...
#endif  // MESH_MSGS__MSG__DETAIL__VECTOR_FIELD__TYPE_SUPPORT_H_
