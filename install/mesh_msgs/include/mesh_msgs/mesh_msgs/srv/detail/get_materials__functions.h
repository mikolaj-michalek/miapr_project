...
#ifndef MESH_MSGS__SRV__DETAIL__GET_MATERIALS__FUNCTIONS_H_
#define MESH_MSGS__SRV__DETAIL__GET_MATERIALS__FUNCTIONS_H_
...
/// Initialize srv/GetMaterials message.
/**
 ...
 * )) before or use
 * mesh_msgs__srv__GetMaterials_Request__create()
...
/// Finalize srv/GetMaterials message.
/**
...
/// Create srv/GetMaterials message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * mesh_msgs__srv__GetMaterials_Request__init().
...
/// Destroy srv/GetMaterials message.
/**
 * It calls
 * mesh_msgs__srv__GetMaterials_Request__fini()
...
/// Check for srv/GetMaterials message equality.
/**
...
/// Copy a srv/GetMaterials message.
/**
...
/// Initialize array of srv/GetMaterials messages.
/**
...
/// Finalize array of srv/GetMaterials messages.
/**
 * It calls
 * mesh_msgs__srv__GetMaterials_Request__fini()
...
/// Create array of srv/GetMaterials messages.
/**
 * It allocates the memory for the array and calls
 * mesh_msgs__srv__GetMaterials_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/GetMaterials messages.
/**
 * It calls
 * mesh_msgs__srv__GetMaterials_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/GetMaterials message array equality.
/**
...
/// Copy an array of srv/GetMaterials messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * )) before or use
 * mesh_msgs__srv__GetMaterials_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_mesh_msgs
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * mesh_msgs__srv__GetMaterials_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mesh_msgs
...
/**
 * It calls
 * mesh_msgs__srv__GetMaterials_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_mesh_msgs
...
/**
 * It allocates the memory for the array and calls
 * mesh_msgs__srv__GetMaterials_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mesh_msgs
...
/**
 * It calls
 * mesh_msgs__srv__GetMaterials_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * mesh_msgs__srv__GetMaterials_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_mesh_msgs
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * mesh_msgs__srv__GetMaterials_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mesh_msgs
...
/**
 * It calls
 * mesh_msgs__srv__GetMaterials_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_mesh_msgs
...
/**
 * It allocates the memory for the array and calls
 * mesh_msgs__srv__GetMaterials_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mesh_msgs
...
/**
 * It calls
 * mesh_msgs__srv__GetMaterials_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MESH_MSGS__SRV__DETAIL__GET_MATERIALS__FUNCTIONS_H_
