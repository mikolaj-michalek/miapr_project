...
static const _MeshMaterials_type_support_symbol_names_t _MeshMaterials_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mesh_msgs, msg, MeshMaterials)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mesh_msgs, msg, MeshMaterials)),
  }
};
...
{
  return &::mesh_msgs::msg::rosidl_typesupport_cpp::MeshMaterials_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mesh_msgs, msg, MeshMaterials)() {
  return get_message_type_support_handle<mesh_msgs::msg::MeshMaterials>();
}
