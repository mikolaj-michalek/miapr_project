...
mesh_msgs__srv__GetTexture_Request__init(mesh_msgs__srv__GetTexture_Request * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->uuid)) {
    mesh_msgs__srv__GetTexture_Request__fini(msg);
    return false;
  }
  // texture_index
  return true;
...
mesh_msgs__srv__GetTexture_Request__create(void)
{
  ...
  mesh_msgs__srv__GetTexture_Request * msg = (mesh_msgs__srv__GetTexture_Request *)allocator.allocate(sizeof(mesh_msgs__srv__GetTexture_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mesh_msgs__srv__GetTexture_Request));
  bool success = mesh_msgs__srv__GetTexture_Request__init(msg);
  if (!success) {
...
mesh_msgs__srv__GetTexture_Request__Sequence__init(mesh_msgs__srv__GetTexture_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mesh_msgs__srv__GetTexture_Request * data = NULL;

  if (size) {
    data = (mesh_msgs__srv__GetTexture_Request *)allocator.zero_allocate(size, sizeof(mesh_msgs__srv__GetTexture_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mesh_msgs__srv__GetTexture_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        mesh_msgs__srv__GetTexture_Request__fini(&data[i - 1]);
      }
...
mesh_msgs__srv__GetTexture_Request__Sequence__fini(mesh_msgs__srv__GetTexture_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      mesh_msgs__srv__GetTexture_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mesh_msgs__srv__GetTexture_Request__Sequence * array = (mesh_msgs__srv__GetTexture_Request__Sequence *)allocator.allocate(sizeof(mesh_msgs__srv__GetTexture_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mesh_msgs__srv__GetTexture_Request__Sequence__init(array, size);
  if (!success) {
...
mesh_msgs__srv__GetTexture_Request__Sequence__destroy(mesh_msgs__srv__GetTexture_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mesh_msgs__srv__GetTexture_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mesh_msgs__srv__GetTexture_Request__Sequence__are_equal(const mesh_msgs__srv__GetTexture_Request__Sequence * lhs, const mesh_msgs__srv__GetTexture_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mesh_msgs__srv__GetTexture_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mesh_msgs__srv__GetTexture_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mesh_msgs__srv__GetTexture_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mesh_msgs__srv__GetTexture_Request * data =
      (mesh_msgs__srv__GetTexture_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mesh_msgs__srv__GetTexture_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mesh_msgs__srv__GetTexture_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!mesh_msgs__srv__GetTexture_Request__copy(
...
mesh_msgs__srv__GetTexture_Response__init(mesh_msgs__srv__GetTexture_Response * msg)
{
  ...
  // texture
  if (!mesh_msgs__msg__MeshTexture__init(&msg->texture)) {
    mesh_msgs__srv__GetTexture_Response__fini(msg);
    return false;
  }
  return true;
}
...
mesh_msgs__srv__GetTexture_Response__fini(mesh_msgs__srv__GetTexture_Response * msg)
{
  ...
  // texture
  mesh_msgs__msg__MeshTexture__fini(&msg->texture);
}
...
mesh_msgs__srv__GetTexture_Response__are_equal(const mesh_msgs__srv__GetTexture_Response * lhs, const mesh_msgs__srv__GetTexture_Response * rhs)
{
  ...
  // texture
  if (!mesh_msgs__msg__MeshTexture__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mesh_msgs__srv__GetTexture_Response * msg = (mesh_msgs__srv__GetTexture_Response *)allocator.allocate(sizeof(mesh_msgs__srv__GetTexture_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mesh_msgs__srv__GetTexture_Response));
  bool success = mesh_msgs__srv__GetTexture_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
mesh_msgs__srv__GetTexture_Response__Sequence__init(mesh_msgs__srv__GetTexture_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mesh_msgs__srv__GetTexture_Response * data = NULL;

  if (size) {
    data = (mesh_msgs__srv__GetTexture_Response *)allocator.zero_allocate(size, sizeof(mesh_msgs__srv__GetTexture_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mesh_msgs__srv__GetTexture_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        mesh_msgs__srv__GetTexture_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
mesh_msgs__srv__GetTexture_Response__Sequence__fini(mesh_msgs__srv__GetTexture_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      mesh_msgs__srv__GetTexture_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mesh_msgs__srv__GetTexture_Response__Sequence * array = (mesh_msgs__srv__GetTexture_Response__Sequence *)allocator.allocate(sizeof(mesh_msgs__srv__GetTexture_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mesh_msgs__srv__GetTexture_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
mesh_msgs__srv__GetTexture_Response__Sequence__destroy(mesh_msgs__srv__GetTexture_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mesh_msgs__srv__GetTexture_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mesh_msgs__srv__GetTexture_Response__Sequence__are_equal(const mesh_msgs__srv__GetTexture_Response__Sequence * lhs, const mesh_msgs__srv__GetTexture_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mesh_msgs__srv__GetTexture_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mesh_msgs__srv__GetTexture_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mesh_msgs__srv__GetTexture_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mesh_msgs__srv__GetTexture_Response * data =
      (mesh_msgs__srv__GetTexture_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mesh_msgs__srv__GetTexture_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mesh_msgs__srv__GetTexture_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!mesh_msgs__srv__GetTexture_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
mesh_msgs__srv__GetTexture_Event__init(mesh_msgs__srv__GetTexture_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    mesh_msgs__srv__GetTexture_Event__fini(msg);
    return false;
  }
  // request
  if (!mesh_msgs__srv__GetTexture_Request__Sequence__init(&msg->request, 0)) {
    mesh_msgs__srv__GetTexture_Event__fini(msg);
    return false;
  }
  // response
  if (!mesh_msgs__srv__GetTexture_Response__Sequence__init(&msg->response, 0)) {
    mesh_msgs__srv__GetTexture_Event__fini(msg);
    return false;
  }
  return true;
...
mesh_msgs__srv__GetTexture_Event__fini(mesh_msgs__srv__GetTexture_Event * msg)
{
  ...
  // request
  mesh_msgs__srv__GetTexture_Request__Sequence__fini(&msg->request);
  // response
  mesh_msgs__srv__GetTexture_Response__Sequence__fini(&msg->response);
}
...
mesh_msgs__srv__GetTexture_Event__are_equal(const mesh_msgs__srv__GetTexture_Event * lhs, const mesh_msgs__srv__GetTexture_Event * rhs)
{
  ...
  // request
  if (!mesh_msgs__srv__GetTexture_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!mesh_msgs__srv__GetTexture_Response__Sequence__are_equal(
  ...
  mesh_msgs__srv__GetTexture_Event * output)
{
  ...
  // request
  if (!mesh_msgs__srv__GetTexture_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!mesh_msgs__srv__GetTexture_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mesh_msgs__srv__GetTexture_Event * msg = (mesh_msgs__srv__GetTexture_Event *)allocator.allocate(sizeof(mesh_msgs__srv__GetTexture_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mesh_msgs__srv__GetTexture_Event));
  bool success = mesh_msgs__srv__GetTexture_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
mesh_msgs__srv__GetTexture_Event__Sequence__init(mesh_msgs__srv__GetTexture_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mesh_msgs__srv__GetTexture_Event * data = NULL;

  if (size) {
    data = (mesh_msgs__srv__GetTexture_Event *)allocator.zero_allocate(size, sizeof(mesh_msgs__srv__GetTexture_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mesh_msgs__srv__GetTexture_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        mesh_msgs__srv__GetTexture_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
mesh_msgs__srv__GetTexture_Event__Sequence__fini(mesh_msgs__srv__GetTexture_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      mesh_msgs__srv__GetTexture_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mesh_msgs__srv__GetTexture_Event__Sequence * array = (mesh_msgs__srv__GetTexture_Event__Sequence *)allocator.allocate(sizeof(mesh_msgs__srv__GetTexture_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mesh_msgs__srv__GetTexture_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
mesh_msgs__srv__GetTexture_Event__Sequence__destroy(mesh_msgs__srv__GetTexture_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mesh_msgs__srv__GetTexture_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mesh_msgs__srv__GetTexture_Event__Sequence__are_equal(const mesh_msgs__srv__GetTexture_Event__Sequence * lhs, const mesh_msgs__srv__GetTexture_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mesh_msgs__srv__GetTexture_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mesh_msgs__srv__GetTexture_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mesh_msgs__srv__GetTexture_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mesh_msgs__srv__GetTexture_Event * data =
      (mesh_msgs__srv__GetTexture_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mesh_msgs__srv__GetTexture_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mesh_msgs__srv__GetTexture_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!mesh_msgs__srv__GetTexture_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
