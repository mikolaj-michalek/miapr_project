...
#include "mesh_msgs/msg/detail/mesh_vertex_tex_coords__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mesh_msgs::msg::MeshVertexTexCoords & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mesh_msgs::msg::MeshVertexTexCoords & ros_message)
{
  // Member: u
  cdr >> ros_message.u;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mesh_msgs::msg::MeshVertexTexCoords;
    is_plain =
      (
      offsetof(DataType, v) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const mesh_msgs::msg::MeshVertexTexCoords *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mesh_msgs::msg::MeshVertexTexCoords *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MeshVertexTexCoords__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mesh_msgs::msg::MeshVertexTexCoords *>(
...
static size_t _MeshVertexTexCoords__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MeshVertexTexCoords(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MeshVertexTexCoords__callbacks = {
  "mesh_msgs::msg",
  "MeshVertexTexCoords",
...
static rosidl_message_type_support_t _MeshVertexTexCoords__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MeshVertexTexCoords__callbacks,
...
{
  return &mesh_msgs::msg::typesupport_fastrtps_cpp::_MeshVertexTexCoords__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mesh_msgs, msg, MeshVertexTexCoords)() {
  return &mesh_msgs::msg::typesupport_fastrtps_cpp::_MeshVertexTexCoords__handle;
}
