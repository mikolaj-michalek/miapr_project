...
class Metaclass_MeshTriangleIndices(type):
    """Metaclass of message 'MeshTriangleIndices'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__mesh_triangle_indices
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__mesh_triangle_indices
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__mesh_triangle_indices
            cls._TYPE_SUPPORT = module.type_support_msg__msg__mesh_triangle_indices
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__mesh_triangle_indices
...
class MeshTriangleIndices(metaclass=Metaclass_MeshTriangleIndices):
    """Message class 'MeshTriangleIndices'."""
