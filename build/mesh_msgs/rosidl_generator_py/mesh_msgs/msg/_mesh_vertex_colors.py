...
class Metaclass_MeshVertexColors(type):
    """Metaclass of message 'MeshVertexColors'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__mesh_vertex_colors
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__mesh_vertex_colors
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__mesh_vertex_colors
            cls._TYPE_SUPPORT = module.type_support_msg__msg__mesh_vertex_colors
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__mesh_vertex_colors
...
class MeshVertexColors(metaclass=Metaclass_MeshVertexColors):
    """Message class 'MeshVertexColors'."""
