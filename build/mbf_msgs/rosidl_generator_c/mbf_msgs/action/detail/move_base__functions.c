...
mbf_msgs__action__MoveBase_Goal__init(mbf_msgs__action__MoveBase_Goal * msg)
{
  ...
  if (!geometry_msgs__msg__PoseStamped__init(&msg->target_pose)) {
    mbf_msgs__action__MoveBase_Goal__fini(msg);
    return false;
  }
  // controller
  ...
  // recovery_behaviors
  if (!rosidl_runtime_c__String__Sequence__init(&msg->recovery_behaviors, 0)) {
    mbf_msgs__action__MoveBase_Goal__fini(msg);
    return false;
  }
  return true;
...
mbf_msgs__action__MoveBase_Goal__fini(mbf_msgs__action__MoveBase_Goal * msg)
{
  ...
  // recovery_behaviors
  rosidl_runtime_c__String__Sequence__fini(&msg->recovery_behaviors);
}
  ...
  mbf_msgs__action__MoveBase_Goal * output)
{
  ...
  if (!rosidl_runtime_c__String__Sequence__copy(
      &(input->recovery_behaviors), &(output->recovery_behaviors)))
  {
    return false;
  }
  return true;
...
mbf_msgs__action__MoveBase_Goal__create(void)
{
  ...
  mbf_msgs__action__MoveBase_Goal * msg = (mbf_msgs__action__MoveBase_Goal *)allocator.allocate(sizeof(mbf_msgs__action__MoveBase_Goal), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mbf_msgs__action__MoveBase_Goal));
  bool success = mbf_msgs__action__MoveBase_Goal__init(msg);
  if (!success) {
...
mbf_msgs__action__MoveBase_Goal__Sequence__init(mbf_msgs__action__MoveBase_Goal__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mbf_msgs__action__MoveBase_Goal * data = NULL;

  if (size) {
    data = (mbf_msgs__action__MoveBase_Goal *)allocator.zero_allocate(size, sizeof(mbf_msgs__action__MoveBase_Goal), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mbf_msgs__action__MoveBase_Goal__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        mbf_msgs__action__MoveBase_Goal__fini(&data[i - 1]);
      }
...
mbf_msgs__action__MoveBase_Goal__Sequence__fini(mbf_msgs__action__MoveBase_Goal__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      mbf_msgs__action__MoveBase_Goal__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mbf_msgs__action__MoveBase_Goal__Sequence * array = (mbf_msgs__action__MoveBase_Goal__Sequence *)allocator.allocate(sizeof(mbf_msgs__action__MoveBase_Goal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mbf_msgs__action__MoveBase_Goal__Sequence__init(array, size);
  if (!success) {
...
mbf_msgs__action__MoveBase_Goal__Sequence__destroy(mbf_msgs__action__MoveBase_Goal__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mbf_msgs__action__MoveBase_Goal__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mbf_msgs__action__MoveBase_Goal__Sequence__are_equal(const mbf_msgs__action__MoveBase_Goal__Sequence * lhs, const mbf_msgs__action__MoveBase_Goal__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mbf_msgs__action__MoveBase_Goal__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mbf_msgs__action__MoveBase_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mbf_msgs__action__MoveBase_Goal);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mbf_msgs__action__MoveBase_Goal * data =
      (mbf_msgs__action__MoveBase_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mbf_msgs__action__MoveBase_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mbf_msgs__action__MoveBase_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!mbf_msgs__action__MoveBase_Goal__copy(
...
mbf_msgs__action__MoveBase_Result__init(mbf_msgs__action__MoveBase_Result * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->message)) {
    mbf_msgs__action__MoveBase_Result__fini(msg);
    return false;
  }
  // dist_to_goal
  // angle_to_goal
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mbf_msgs__action__MoveBase_Result * msg = (mbf_msgs__action__MoveBase_Result *)allocator.allocate(sizeof(mbf_msgs__action__MoveBase_Result), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mbf_msgs__action__MoveBase_Result));
  bool success = mbf_msgs__action__MoveBase_Result__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
mbf_msgs__action__MoveBase_Result__Sequence__init(mbf_msgs__action__MoveBase_Result__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mbf_msgs__action__MoveBase_Result * data = NULL;

  if (size) {
    data = (mbf_msgs__action__MoveBase_Result *)allocator.zero_allocate(size, sizeof(mbf_msgs__action__MoveBase_Result), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mbf_msgs__action__MoveBase_Result__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        mbf_msgs__action__MoveBase_Result__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
mbf_msgs__action__MoveBase_Result__Sequence__fini(mbf_msgs__action__MoveBase_Result__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      mbf_msgs__action__MoveBase_Result__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mbf_msgs__action__MoveBase_Result__Sequence * array = (mbf_msgs__action__MoveBase_Result__Sequence *)allocator.allocate(sizeof(mbf_msgs__action__MoveBase_Result__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mbf_msgs__action__MoveBase_Result__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
mbf_msgs__action__MoveBase_Result__Sequence__destroy(mbf_msgs__action__MoveBase_Result__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mbf_msgs__action__MoveBase_Result__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mbf_msgs__action__MoveBase_Result__Sequence__are_equal(const mbf_msgs__action__MoveBase_Result__Sequence * lhs, const mbf_msgs__action__MoveBase_Result__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mbf_msgs__action__MoveBase_Result__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mbf_msgs__action__MoveBase_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mbf_msgs__action__MoveBase_Result);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mbf_msgs__action__MoveBase_Result * data =
      (mbf_msgs__action__MoveBase_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mbf_msgs__action__MoveBase_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mbf_msgs__action__MoveBase_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!mbf_msgs__action__MoveBase_Result__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
mbf_msgs__action__MoveBase_Feedback__init(mbf_msgs__action__MoveBase_Feedback * msg)
{
  ...
  // message
  if (!rosidl_runtime_c__String__init(&msg->message)) {
    mbf_msgs__action__MoveBase_Feedback__fini(msg);
    return false;
  }
  // dist_to_goal
  // angle_to_goal
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mbf_msgs__action__MoveBase_Feedback * msg = (mbf_msgs__action__MoveBase_Feedback *)allocator.allocate(sizeof(mbf_msgs__action__MoveBase_Feedback), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mbf_msgs__action__MoveBase_Feedback));
  bool success = mbf_msgs__action__MoveBase_Feedback__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
mbf_msgs__action__MoveBase_Feedback__Sequence__init(mbf_msgs__action__MoveBase_Feedback__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mbf_msgs__action__MoveBase_Feedback * data = NULL;

  if (size) {
    data = (mbf_msgs__action__MoveBase_Feedback *)allocator.zero_allocate(size, sizeof(mbf_msgs__action__MoveBase_Feedback), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mbf_msgs__action__MoveBase_Feedback__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        mbf_msgs__action__MoveBase_Feedback__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
mbf_msgs__action__MoveBase_Feedback__Sequence__fini(mbf_msgs__action__MoveBase_Feedback__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      mbf_msgs__action__MoveBase_Feedback__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mbf_msgs__action__MoveBase_Feedback__Sequence * array = (mbf_msgs__action__MoveBase_Feedback__Sequence *)allocator.allocate(sizeof(mbf_msgs__action__MoveBase_Feedback__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mbf_msgs__action__MoveBase_Feedback__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
mbf_msgs__action__MoveBase_Feedback__Sequence__destroy(mbf_msgs__action__MoveBase_Feedback__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mbf_msgs__action__MoveBase_Feedback__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mbf_msgs__action__MoveBase_Feedback__Sequence__are_equal(const mbf_msgs__action__MoveBase_Feedback__Sequence * lhs, const mbf_msgs__action__MoveBase_Feedback__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mbf_msgs__action__MoveBase_Feedback__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mbf_msgs__action__MoveBase_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mbf_msgs__action__MoveBase_Feedback);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mbf_msgs__action__MoveBase_Feedback * data =
      (mbf_msgs__action__MoveBase_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mbf_msgs__action__MoveBase_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mbf_msgs__action__MoveBase_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!mbf_msgs__action__MoveBase_Feedback__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
mbf_msgs__action__MoveBase_SendGoal_Request__init(mbf_msgs__action__MoveBase_SendGoal_Request * msg)
{
  ...
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    mbf_msgs__action__MoveBase_SendGoal_Request__fini(msg);
    return false;
  }
  // goal
  if (!mbf_msgs__action__MoveBase_Goal__init(&msg->goal)) {
    mbf_msgs__action__MoveBase_SendGoal_Request__fini(msg);
    return false;
  }
  return true;
...
mbf_msgs__action__MoveBase_SendGoal_Request__fini(mbf_msgs__action__MoveBase_SendGoal_Request * msg)
{
  ...
  // goal
  mbf_msgs__action__MoveBase_Goal__fini(&msg->goal);
}
...
mbf_msgs__action__MoveBase_SendGoal_Request__are_equal(const mbf_msgs__action__MoveBase_SendGoal_Request * lhs, const mbf_msgs__action__MoveBase_SendGoal_Request * rhs)
{
  ...
  // goal
  if (!mbf_msgs__action__MoveBase_Goal__are_equal(
      &(lhs->goal), &(rhs->goal)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mbf_msgs__action__MoveBase_SendGoal_Request * msg = (mbf_msgs__action__MoveBase_SendGoal_Request *)allocator.allocate(sizeof(mbf_msgs__action__MoveBase_SendGoal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mbf_msgs__action__MoveBase_SendGoal_Request));
  bool success = mbf_msgs__action__MoveBase_SendGoal_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
mbf_msgs__action__MoveBase_SendGoal_Request__Sequence__init(mbf_msgs__action__MoveBase_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mbf_msgs__action__MoveBase_SendGoal_Request * data = NULL;

  if (size) {
    data = (mbf_msgs__action__MoveBase_SendGoal_Request *)allocator.zero_allocate(size, sizeof(mbf_msgs__action__MoveBase_SendGoal_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mbf_msgs__action__MoveBase_SendGoal_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        mbf_msgs__action__MoveBase_SendGoal_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
mbf_msgs__action__MoveBase_SendGoal_Request__Sequence__fini(mbf_msgs__action__MoveBase_SendGoal_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      mbf_msgs__action__MoveBase_SendGoal_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mbf_msgs__action__MoveBase_SendGoal_Request__Sequence * array = (mbf_msgs__action__MoveBase_SendGoal_Request__Sequence *)allocator.allocate(sizeof(mbf_msgs__action__MoveBase_SendGoal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mbf_msgs__action__MoveBase_SendGoal_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
mbf_msgs__action__MoveBase_SendGoal_Request__Sequence__destroy(mbf_msgs__action__MoveBase_SendGoal_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mbf_msgs__action__MoveBase_SendGoal_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mbf_msgs__action__MoveBase_SendGoal_Request__Sequence__are_equal(const mbf_msgs__action__MoveBase_SendGoal_Request__Sequence * lhs, const mbf_msgs__action__MoveBase_SendGoal_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mbf_msgs__action__MoveBase_SendGoal_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mbf_msgs__action__MoveBase_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mbf_msgs__action__MoveBase_SendGoal_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mbf_msgs__action__MoveBase_SendGoal_Request * data =
      (mbf_msgs__action__MoveBase_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mbf_msgs__action__MoveBase_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mbf_msgs__action__MoveBase_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!mbf_msgs__action__MoveBase_SendGoal_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
mbf_msgs__action__MoveBase_SendGoal_Response__init(mbf_msgs__action__MoveBase_SendGoal_Response * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    mbf_msgs__action__MoveBase_SendGoal_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mbf_msgs__action__MoveBase_SendGoal_Response * msg = (mbf_msgs__action__MoveBase_SendGoal_Response *)allocator.allocate(sizeof(mbf_msgs__action__MoveBase_SendGoal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mbf_msgs__action__MoveBase_SendGoal_Response));
  bool success = mbf_msgs__action__MoveBase_SendGoal_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
mbf_msgs__action__MoveBase_SendGoal_Response__Sequence__init(mbf_msgs__action__MoveBase_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mbf_msgs__action__MoveBase_SendGoal_Response * data = NULL;

  if (size) {
    data = (mbf_msgs__action__MoveBase_SendGoal_Response *)allocator.zero_allocate(size, sizeof(mbf_msgs__action__MoveBase_SendGoal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mbf_msgs__action__MoveBase_SendGoal_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        mbf_msgs__action__MoveBase_SendGoal_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
mbf_msgs__action__MoveBase_SendGoal_Response__Sequence__fini(mbf_msgs__action__MoveBase_SendGoal_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      mbf_msgs__action__MoveBase_SendGoal_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mbf_msgs__action__MoveBase_SendGoal_Response__Sequence * array = (mbf_msgs__action__MoveBase_SendGoal_Response__Sequence *)allocator.allocate(sizeof(mbf_msgs__action__MoveBase_SendGoal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mbf_msgs__action__MoveBase_SendGoal_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
mbf_msgs__action__MoveBase_SendGoal_Response__Sequence__destroy(mbf_msgs__action__MoveBase_SendGoal_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mbf_msgs__action__MoveBase_SendGoal_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mbf_msgs__action__MoveBase_SendGoal_Response__Sequence__are_equal(const mbf_msgs__action__MoveBase_SendGoal_Response__Sequence * lhs, const mbf_msgs__action__MoveBase_SendGoal_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mbf_msgs__action__MoveBase_SendGoal_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mbf_msgs__action__MoveBase_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mbf_msgs__action__MoveBase_SendGoal_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mbf_msgs__action__MoveBase_SendGoal_Response * data =
      (mbf_msgs__action__MoveBase_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mbf_msgs__action__MoveBase_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mbf_msgs__action__MoveBase_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!mbf_msgs__action__MoveBase_SendGoal_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
mbf_msgs__action__MoveBase_SendGoal_Event__init(mbf_msgs__action__MoveBase_SendGoal_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    mbf_msgs__action__MoveBase_SendGoal_Event__fini(msg);
    return false;
  }
  // request
  if (!mbf_msgs__action__MoveBase_SendGoal_Request__Sequence__init(&msg->request, 0)) {
    mbf_msgs__action__MoveBase_SendGoal_Event__fini(msg);
    return false;
  }
  // response
  if (!mbf_msgs__action__MoveBase_SendGoal_Response__Sequence__init(&msg->response, 0)) {
    mbf_msgs__action__MoveBase_SendGoal_Event__fini(msg);
    return false;
  }
  return true;
...
mbf_msgs__action__MoveBase_SendGoal_Event__fini(mbf_msgs__action__MoveBase_SendGoal_Event * msg)
{
  ...
  // request
  mbf_msgs__action__MoveBase_SendGoal_Request__Sequence__fini(&msg->request);
  // response
  mbf_msgs__action__MoveBase_SendGoal_Response__Sequence__fini(&msg->response);
}
...
mbf_msgs__action__MoveBase_SendGoal_Event__are_equal(const mbf_msgs__action__MoveBase_SendGoal_Event * lhs, const mbf_msgs__action__MoveBase_SendGoal_Event * rhs)
{
  ...
  // request
  if (!mbf_msgs__action__MoveBase_SendGoal_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!mbf_msgs__action__MoveBase_SendGoal_Response__Sequence__are_equal(
  ...
  mbf_msgs__action__MoveBase_SendGoal_Event * output)
{
  ...
  // request
  if (!mbf_msgs__action__MoveBase_SendGoal_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!mbf_msgs__action__MoveBase_SendGoal_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mbf_msgs__action__MoveBase_SendGoal_Event * msg = (mbf_msgs__action__MoveBase_SendGoal_Event *)allocator.allocate(sizeof(mbf_msgs__action__MoveBase_SendGoal_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mbf_msgs__action__MoveBase_SendGoal_Event));
  bool success = mbf_msgs__action__MoveBase_SendGoal_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
mbf_msgs__action__MoveBase_SendGoal_Event__Sequence__init(mbf_msgs__action__MoveBase_SendGoal_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mbf_msgs__action__MoveBase_SendGoal_Event * data = NULL;

  if (size) {
    data = (mbf_msgs__action__MoveBase_SendGoal_Event *)allocator.zero_allocate(size, sizeof(mbf_msgs__action__MoveBase_SendGoal_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mbf_msgs__action__MoveBase_SendGoal_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        mbf_msgs__action__MoveBase_SendGoal_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
mbf_msgs__action__MoveBase_SendGoal_Event__Sequence__fini(mbf_msgs__action__MoveBase_SendGoal_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      mbf_msgs__action__MoveBase_SendGoal_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mbf_msgs__action__MoveBase_SendGoal_Event__Sequence * array = (mbf_msgs__action__MoveBase_SendGoal_Event__Sequence *)allocator.allocate(sizeof(mbf_msgs__action__MoveBase_SendGoal_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mbf_msgs__action__MoveBase_SendGoal_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
mbf_msgs__action__MoveBase_SendGoal_Event__Sequence__destroy(mbf_msgs__action__MoveBase_SendGoal_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mbf_msgs__action__MoveBase_SendGoal_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mbf_msgs__action__MoveBase_SendGoal_Event__Sequence__are_equal(const mbf_msgs__action__MoveBase_SendGoal_Event__Sequence * lhs, const mbf_msgs__action__MoveBase_SendGoal_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mbf_msgs__action__MoveBase_SendGoal_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mbf_msgs__action__MoveBase_SendGoal_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mbf_msgs__action__MoveBase_SendGoal_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mbf_msgs__action__MoveBase_SendGoal_Event * data =
      (mbf_msgs__action__MoveBase_SendGoal_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mbf_msgs__action__MoveBase_SendGoal_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mbf_msgs__action__MoveBase_SendGoal_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!mbf_msgs__action__MoveBase_SendGoal_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
mbf_msgs__action__MoveBase_GetResult_Request__init(mbf_msgs__action__MoveBase_GetResult_Request * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    mbf_msgs__action__MoveBase_GetResult_Request__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mbf_msgs__action__MoveBase_GetResult_Request * msg = (mbf_msgs__action__MoveBase_GetResult_Request *)allocator.allocate(sizeof(mbf_msgs__action__MoveBase_GetResult_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mbf_msgs__action__MoveBase_GetResult_Request));
  bool success = mbf_msgs__action__MoveBase_GetResult_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
mbf_msgs__action__MoveBase_GetResult_Request__Sequence__init(mbf_msgs__action__MoveBase_GetResult_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mbf_msgs__action__MoveBase_GetResult_Request * data = NULL;

  if (size) {
    data = (mbf_msgs__action__MoveBase_GetResult_Request *)allocator.zero_allocate(size, sizeof(mbf_msgs__action__MoveBase_GetResult_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mbf_msgs__action__MoveBase_GetResult_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        mbf_msgs__action__MoveBase_GetResult_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
mbf_msgs__action__MoveBase_GetResult_Request__Sequence__fini(mbf_msgs__action__MoveBase_GetResult_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      mbf_msgs__action__MoveBase_GetResult_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mbf_msgs__action__MoveBase_GetResult_Request__Sequence * array = (mbf_msgs__action__MoveBase_GetResult_Request__Sequence *)allocator.allocate(sizeof(mbf_msgs__action__MoveBase_GetResult_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mbf_msgs__action__MoveBase_GetResult_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
mbf_msgs__action__MoveBase_GetResult_Request__Sequence__destroy(mbf_msgs__action__MoveBase_GetResult_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mbf_msgs__action__MoveBase_GetResult_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mbf_msgs__action__MoveBase_GetResult_Request__Sequence__are_equal(const mbf_msgs__action__MoveBase_GetResult_Request__Sequence * lhs, const mbf_msgs__action__MoveBase_GetResult_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mbf_msgs__action__MoveBase_GetResult_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mbf_msgs__action__MoveBase_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mbf_msgs__action__MoveBase_GetResult_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mbf_msgs__action__MoveBase_GetResult_Request * data =
      (mbf_msgs__action__MoveBase_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mbf_msgs__action__MoveBase_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mbf_msgs__action__MoveBase_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!mbf_msgs__action__MoveBase_GetResult_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
mbf_msgs__action__MoveBase_GetResult_Response__init(mbf_msgs__action__MoveBase_GetResult_Response * msg)
{
  ...
  // status
  // result
  if (!mbf_msgs__action__MoveBase_Result__init(&msg->result)) {
    mbf_msgs__action__MoveBase_GetResult_Response__fini(msg);
    return false;
  }
  return true;
}
...
mbf_msgs__action__MoveBase_GetResult_Response__fini(mbf_msgs__action__MoveBase_GetResult_Response * msg)
{
  ...
  // status
  // result
  mbf_msgs__action__MoveBase_Result__fini(&msg->result);
}
...
mbf_msgs__action__MoveBase_GetResult_Response__are_equal(const mbf_msgs__action__MoveBase_GetResult_Response * lhs, const mbf_msgs__action__MoveBase_GetResult_Response * rhs)
{
  ...
  // result
  if (!mbf_msgs__action__MoveBase_Result__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mbf_msgs__action__MoveBase_GetResult_Response * msg = (mbf_msgs__action__MoveBase_GetResult_Response *)allocator.allocate(sizeof(mbf_msgs__action__MoveBase_GetResult_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mbf_msgs__action__MoveBase_GetResult_Response));
  bool success = mbf_msgs__action__MoveBase_GetResult_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
mbf_msgs__action__MoveBase_GetResult_Response__Sequence__init(mbf_msgs__action__MoveBase_GetResult_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mbf_msgs__action__MoveBase_GetResult_Response * data = NULL;

  if (size) {
    data = (mbf_msgs__action__MoveBase_GetResult_Response *)allocator.zero_allocate(size, sizeof(mbf_msgs__action__MoveBase_GetResult_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mbf_msgs__action__MoveBase_GetResult_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        mbf_msgs__action__MoveBase_GetResult_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
mbf_msgs__action__MoveBase_GetResult_Response__Sequence__fini(mbf_msgs__action__MoveBase_GetResult_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      mbf_msgs__action__MoveBase_GetResult_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mbf_msgs__action__MoveBase_GetResult_Response__Sequence * array = (mbf_msgs__action__MoveBase_GetResult_Response__Sequence *)allocator.allocate(sizeof(mbf_msgs__action__MoveBase_GetResult_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mbf_msgs__action__MoveBase_GetResult_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
mbf_msgs__action__MoveBase_GetResult_Response__Sequence__destroy(mbf_msgs__action__MoveBase_GetResult_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mbf_msgs__action__MoveBase_GetResult_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mbf_msgs__action__MoveBase_GetResult_Response__Sequence__are_equal(const mbf_msgs__action__MoveBase_GetResult_Response__Sequence * lhs, const mbf_msgs__action__MoveBase_GetResult_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mbf_msgs__action__MoveBase_GetResult_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mbf_msgs__action__MoveBase_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mbf_msgs__action__MoveBase_GetResult_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mbf_msgs__action__MoveBase_GetResult_Response * data =
      (mbf_msgs__action__MoveBase_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mbf_msgs__action__MoveBase_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mbf_msgs__action__MoveBase_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!mbf_msgs__action__MoveBase_GetResult_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
mbf_msgs__action__MoveBase_GetResult_Event__init(mbf_msgs__action__MoveBase_GetResult_Event * msg)
{
  ...
  // info
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    mbf_msgs__action__MoveBase_GetResult_Event__fini(msg);
    return false;
  }
  // request
  if (!mbf_msgs__action__MoveBase_GetResult_Request__Sequence__init(&msg->request, 0)) {
    mbf_msgs__action__MoveBase_GetResult_Event__fini(msg);
    return false;
  }
  // response
  if (!mbf_msgs__action__MoveBase_GetResult_Response__Sequence__init(&msg->response, 0)) {
    mbf_msgs__action__MoveBase_GetResult_Event__fini(msg);
    return false;
  }
  return true;
...
mbf_msgs__action__MoveBase_GetResult_Event__fini(mbf_msgs__action__MoveBase_GetResult_Event * msg)
{
  ...
  service_msgs__msg__ServiceEventInfo__fini(&msg->info);
  // request
  mbf_msgs__action__MoveBase_GetResult_Request__Sequence__fini(&msg->request);
  // response
  mbf_msgs__action__MoveBase_GetResult_Response__Sequence__fini(&msg->response);
}
...
mbf_msgs__action__MoveBase_GetResult_Event__are_equal(const mbf_msgs__action__MoveBase_GetResult_Event * lhs, const mbf_msgs__action__MoveBase_GetResult_Event * rhs)
{
  ...
  // request
  if (!mbf_msgs__action__MoveBase_GetResult_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!mbf_msgs__action__MoveBase_GetResult_Response__Sequence__are_equal(
      &(lhs->response), &(rhs->response)))
  {
    return false;
  }
  ...
  mbf_msgs__action__MoveBase_GetResult_Event * output)
{
  ...
  // request
  if (!mbf_msgs__action__MoveBase_GetResult_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!mbf_msgs__action__MoveBase_GetResult_Response__Sequence__copy(
      &(input->response), &(output->response)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mbf_msgs__action__MoveBase_GetResult_Event * msg = (mbf_msgs__action__MoveBase_GetResult_Event *)allocator.allocate(sizeof(mbf_msgs__action__MoveBase_GetResult_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mbf_msgs__action__MoveBase_GetResult_Event));
  bool success = mbf_msgs__action__MoveBase_GetResult_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
mbf_msgs__action__MoveBase_GetResult_Event__Sequence__init(mbf_msgs__action__MoveBase_GetResult_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mbf_msgs__action__MoveBase_GetResult_Event * data = NULL;

  if (size) {
    data = (mbf_msgs__action__MoveBase_GetResult_Event *)allocator.zero_allocate(size, sizeof(mbf_msgs__action__MoveBase_GetResult_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mbf_msgs__action__MoveBase_GetResult_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        mbf_msgs__action__MoveBase_GetResult_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
mbf_msgs__action__MoveBase_GetResult_Event__Sequence__fini(mbf_msgs__action__MoveBase_GetResult_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      mbf_msgs__action__MoveBase_GetResult_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mbf_msgs__action__MoveBase_GetResult_Event__Sequence * array = (mbf_msgs__action__MoveBase_GetResult_Event__Sequence *)allocator.allocate(sizeof(mbf_msgs__action__MoveBase_GetResult_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mbf_msgs__action__MoveBase_GetResult_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
mbf_msgs__action__MoveBase_GetResult_Event__Sequence__destroy(mbf_msgs__action__MoveBase_GetResult_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mbf_msgs__action__MoveBase_GetResult_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mbf_msgs__action__MoveBase_GetResult_Event__Sequence__are_equal(const mbf_msgs__action__MoveBase_GetResult_Event__Sequence * lhs, const mbf_msgs__action__MoveBase_GetResult_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mbf_msgs__action__MoveBase_GetResult_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mbf_msgs__action__MoveBase_GetResult_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mbf_msgs__action__MoveBase_GetResult_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mbf_msgs__action__MoveBase_GetResult_Event * data =
      (mbf_msgs__action__MoveBase_GetResult_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mbf_msgs__action__MoveBase_GetResult_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mbf_msgs__action__MoveBase_GetResult_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!mbf_msgs__action__MoveBase_GetResult_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
mbf_msgs__action__MoveBase_FeedbackMessage__init(mbf_msgs__action__MoveBase_FeedbackMessage * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    mbf_msgs__action__MoveBase_FeedbackMessage__fini(msg);
    return false;
  }
  // feedback
  if (!mbf_msgs__action__MoveBase_Feedback__init(&msg->feedback)) {
    mbf_msgs__action__MoveBase_FeedbackMessage__fini(msg);
    return false;
  }
  return true;
...
mbf_msgs__action__MoveBase_FeedbackMessage__fini(mbf_msgs__action__MoveBase_FeedbackMessage * msg)
{
  ...
  unique_identifier_msgs__msg__UUID__fini(&msg->goal_id);
  // feedback
  mbf_msgs__action__MoveBase_Feedback__fini(&msg->feedback);
}
...
mbf_msgs__action__MoveBase_FeedbackMessage__are_equal(const mbf_msgs__action__MoveBase_FeedbackMessage * lhs, const mbf_msgs__action__MoveBase_FeedbackMessage * rhs)
{
  ...
  // feedback
  if (!mbf_msgs__action__MoveBase_Feedback__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mbf_msgs__action__MoveBase_FeedbackMessage * msg = (mbf_msgs__action__MoveBase_FeedbackMessage *)allocator.allocate(sizeof(mbf_msgs__action__MoveBase_FeedbackMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mbf_msgs__action__MoveBase_FeedbackMessage));
  bool success = mbf_msgs__action__MoveBase_FeedbackMessage__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
mbf_msgs__action__MoveBase_FeedbackMessage__Sequence__init(mbf_msgs__action__MoveBase_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mbf_msgs__action__MoveBase_FeedbackMessage * data = NULL;

  if (size) {
    data = (mbf_msgs__action__MoveBase_FeedbackMessage *)allocator.zero_allocate(size, sizeof(mbf_msgs__action__MoveBase_FeedbackMessage), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mbf_msgs__action__MoveBase_FeedbackMessage__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        mbf_msgs__action__MoveBase_FeedbackMessage__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
mbf_msgs__action__MoveBase_FeedbackMessage__Sequence__fini(mbf_msgs__action__MoveBase_FeedbackMessage__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      mbf_msgs__action__MoveBase_FeedbackMessage__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mbf_msgs__action__MoveBase_FeedbackMessage__Sequence * array = (mbf_msgs__action__MoveBase_FeedbackMessage__Sequence *)allocator.allocate(sizeof(mbf_msgs__action__MoveBase_FeedbackMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mbf_msgs__action__MoveBase_FeedbackMessage__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
mbf_msgs__action__MoveBase_FeedbackMessage__Sequence__destroy(mbf_msgs__action__MoveBase_FeedbackMessage__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mbf_msgs__action__MoveBase_FeedbackMessage__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mbf_msgs__action__MoveBase_FeedbackMessage__Sequence__are_equal(const mbf_msgs__action__MoveBase_FeedbackMessage__Sequence * lhs, const mbf_msgs__action__MoveBase_FeedbackMessage__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mbf_msgs__action__MoveBase_FeedbackMessage__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mbf_msgs__action__MoveBase_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mbf_msgs__action__MoveBase_FeedbackMessage);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mbf_msgs__action__MoveBase_FeedbackMessage * data =
      (mbf_msgs__action__MoveBase_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mbf_msgs__action__MoveBase_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mbf_msgs__action__MoveBase_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!mbf_msgs__action__MoveBase_FeedbackMessage__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
